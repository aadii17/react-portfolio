...
function Footer() {
  return (
    <footer className="footer--container">
      ...
      <div>
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.instagram.com/aadii___17/?igshid=MzRlODBiNWFlZA%3D%3D"
            ...
            <li>
              <a
                href="https://twitter.com/i/flow/login?redirect_after_login=%2Faadii_17"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/authwall?trk=bf&trkInfo=AQFLaooN9y6IFAAAAYq3_W5QHnFmQGXq1_dwA-pnkKWYF3qpLLf9iglGc9AF9THlj0UtcqGJJv5o7FhFdr2IXJ8-W9OpUYsb-drcqJCnGbETKh68n1-z2U1bv_z4uT2HXbljwms=&original_referer=&sessionRedirect=https%3A%2F%2Fwww.linkedin.com%2Fin%2Faadarsh-choudhari-89b6821b7"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
     ...
     <p className="copyright">© {new Date().getFullYear()} - Built with Love By Aadi</p>
    </footer>
  );
}
